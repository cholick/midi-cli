...
func NoteNumberFromName(noteName string) (int, error) {
	if len(noteName) == 0 {
	...
	if !ok {
		return -1, fmt.Errorf("note %s not found (examples of expected format include C4, C#4, Db4", noteName)
	}
